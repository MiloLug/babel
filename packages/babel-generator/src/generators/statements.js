...
export function VariableDeclaration(node: Object, parent: Object) {
  if (t.isForStatement(parent)) {
    ...
    this._jsvar_plain_wrap = false;
    // scopeVariable(node.declarations, node, {
    // 	wrapper: {
    // 		left() {
    // 			this.word("JSVar *");
    // 		},
...
export function CodeNativeStatement(node: Object) {
  this.newline();
  this.word(node.argument.code);
  this.newline();
}
